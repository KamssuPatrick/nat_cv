            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                            ...
                            child: socialButton(FontAwesomeIcons.solidStar, selected: statusFilm)),
                        GestureDetector(
                            onTap: () {
                              setState(() {
                                statusHome = false;
                            ...
                            },child: socialButton(FontAwesomeIcons.briefcase, selected: statusData)),
                        GestureDetector(
                            onTap: (){
                              setState(() {
                                statusHome = false;
                    ...
                    statusHome ? AccueilPage() :
                    statusFilm ? Container(
                      // padding: EdgeInsets.all(1),
                        child: FavorisPage()) :
                        statusData ? Container(
                          child: Center(
                            child: Text("Data"),
                          ),
                        ) :
                            statusChat ? Container(
                              child: Center(
                                child: Text("Chat"),
                              ),
                            ) :
